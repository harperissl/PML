...
We built a predictive model for activity recognition using the <b>Random Forest</b> algorithm. This is because it automatically selects important variables and is robust to correlated covariates and outliers in general. 
We will use <b>5-fold cross-validation</b> when evaluating the model's performance.
